...
mkdir -p /mnt/{.snapshots,boot/{efi,grub},home/kronikpillow,mnt/{ssd,hdd,usb,windows-c,windows-d},opt,root,srv,usr/local,var/{cache,lib/{containers,docker,flatpak,libvirt,machines,portables},log,spool,tmp}}
...
mount -o defaults,noatime,compress=zstd:1,space_cache=v2,autodefrag,commit=120 /dev/sda3 /mnt/home/kronikpillow
mkdir -p /mnt/home/kronikpillow/{.snapshots,.cache,.local/share/Steam,.var,Documents,Downloads,Music,Pictures,Videos,repos}
mount -o defaults,noatime,compress=zstd:1,space_cache=v2,autodefrag,commit=120,subvol=@kronikpillow/.snapshots /dev/sda3 /mnt/home/kronikpillow/.snapshots
mount -o defaults,noatime,compress=zstd:1,space_cache=v2,autodefrag,commit=120,subvol=@kronikpillow/.cache /dev/sda3 /mnt/home/kronikpillow/.cache
mount -o defaults,noatime,compress=zstd:1,space_cache=v2,autodefrag,commit=120,subvol=@kronikpillow/.local/share/Steam /dev/sda3 /mnt/home/kronikpillow/.local/share/Steam
mount -o defaults,noatime,compress=zstd:1,space_cache=v2,autodefrag,commit=120,subvol=@kronikpillow/.var /dev/sda3 /mnt/home/kronikpillow/.var
mount -o defaults,noatime,compress=zstd:1,space_cache=v2,autodefrag,commit=120,subvol=@kronikpillow/Documents /dev/sda3 /mnt/home/kronikpillow/Documents
mount -o defaults,noatime,compress=zstd:1,space_cache=v2,autodefrag,commit=120,subvol=@kronikpillow/Downloads /dev/sdb2 /mnt/home/kronikpillow/Downloads
mount -o defaults,noatime,compress=zstd:1,space_cache=v2,autodefrag,commit=120,subvol=@kronikpillow/Music /dev/sdb2 /mnt/home/kronikpillow/Music
mount -o defaults,noatime,compress=zstd:1,space_cache=v2,autodefrag,commit=120,subvol=@kronikpillow/Pictures /dev/sdb2 /mnt/home/kronikpillow/Pictures
mount -o defaults,noatime,compress=zstd:1,space_cache=v2,autodefrag,commit=120,subvol=@kronikpillow/Videos /dev/sdb2 /mnt/home/kronikpillow/Videos
mount -o defaults,noatime,compress=zstd:1,space_cache=v2,autodefrag,commit=120,subvol=@kronikpillow/repos /dev/sda3 /mnt/home/kronikpillow/repos
...
mount -o defaults,noatime,compress=zstd:1,space_cache=v2,autodefrag,commit=120,subvol=@/var/lib/docker/btrfs/subvolumes /dev/sdb2 /mnt/var/lib/docker/btrfs/subvolumes
...
mount -o defaults,noatime,compress=zstd:1,space_cache=v2,autodefrag,commit=120,subvol=@/var/lib/libvirt/images /dev/sdb2 /mnt/var/lib/libvirt/images
