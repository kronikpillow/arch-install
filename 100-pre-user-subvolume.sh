...
# setup mount points
mkdir -p /mnt/@/{.snapshots,boot,home,mnt/{btrfs,data,backup,usb,c,d},opt,root,srv,usr/local,var/{cache/pacman/pkg,lib/{docker,flatpak,libvirt,machines,portables},log,tmp}}
